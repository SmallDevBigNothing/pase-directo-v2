...
// Cache Intl formatters to avoid expensive instantiations in loop-bound render functions
...
const localFormatter = new Intl.DateTimeFormat('sv-SE', { timeZone: 'Europe/Madrid' });
...
function formatMatchDate(dateString) {
    ...
    const tomorrowStr = localFormatter.format(new Date(now.getTime() + 86400000));
    const matchDayStr = localFormatter.format(date);
