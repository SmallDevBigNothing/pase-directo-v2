...
<body>
    ...
    <main class="container">
        <div class="search-bar">
            ...
            <input type="text" id="search-input" placeholder="Search by team, competition or sport..." aria-label="Search by team, competition or sport" autocomplete="off">
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="toggle-switch" title="Toggle Live/Upcoming">
                                <input type="checkbox" aria-label="Toggle Live or Upcoming" ${isLive ? 'checked' : ''} onchange="toggleStatus('${m.id}', this)">
