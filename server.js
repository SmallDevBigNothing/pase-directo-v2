...
if (process.env.NODE_ENV === 'production' && !process.env.SESSION_SECRET) {
    throw new Error('CRITICAL: SESSION_SECRET environment variable is missing in production. Application cannot start securely.');
}
...
app.post('/admin/login', (req, res) => {
    ...
    // If ADMIN_PASSWORD is not explicitly set, safely fail and redirect.
