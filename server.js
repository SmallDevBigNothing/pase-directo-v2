...
function teamAvatarHTML(name, logoUrl) {
    ...
    if (logoUrl) {
        return `<img class="team-logo" src="${logoUrl}" alt="" aria-hidden="true" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="team-avatar" style="background:${color};display:none" aria-hidden="true">${initials}</div>`;
    }
    return `<img class="team-logo" data-auto-logo="${escapeHtml(name)}" alt="" aria-hidden="true" style="display:none" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><div class="team-avatar" style="background:${color}" aria-hidden="true">${initials}</div>`;
}
