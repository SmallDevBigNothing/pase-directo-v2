...
// --- HELPER FUNCTIONS ---
// ============================================================
const cachedTimeFormatter = new Intl.DateTimeFormat('en-US', { hour: '2-digit', minute: '2-digit', hour12: false, timeZone: 'Europe/Madrid' });
const cachedDateFormatter = new Intl.DateTimeFormat('en-US', { weekday: 'long', day: 'numeric', month: 'long', timeZone: 'Europe/Madrid' });
const cachedLocalFormatter = new Intl.DateTimeFormat('sv-SE', { timeZone: 'Europe/Madrid' });
...
function formatMatchDate(dateString) {
    ...
    const timeStr = cachedTimeFormatter.format(date);

    const now = new Date();
    const getLocal = (d) => cachedLocalFormatter.format(d);
    ...
    let dateStr = cachedDateFormatter.format(date);
