            ...
            <form id="match-form" action="/admin/add" method="POST">
                <div class="form-grid">
                    <div class="form-group">
                        <label for="local">Home Team</label>
                        <input type="text" id="local" name="local" placeholder="e.g. Real Madrid" required>
                    </div>
                    <div class="form-group">
                        <label for="visitante">Away Team</label>
                        <input type="text" id="visitante" name="visitante" placeholder="e.g. Barcelona (optional)">
                    </div>
                    <div class="form-group">
                        <label for="hora">Date & Time</label>
                        <input type="datetime-local" id="hora" name="hora" required>
                    </div>
                    <div class="form-group">
                        <label for="competicion">Competition</label>
                    ...
                    <div class="form-group">
                        <label for="ucaster_id_1">Channel 1 ID</label>
                        <input type="text" id="ucaster_id_1" name="ucaster_id_1" placeholder="e.g. jfgjj4hfdzx">
                    </div>
                    <div class="form-group">
                        <label for="ucaster_script_1">Channel 1 Script URL</label>
                        <input type="url" id="ucaster_script_1" name="ucaster_script_1" placeholder="e.g. https://new.lastzone.top/static/scripts/hucaster.js">
                    </div>

                    <div class="section-divider-label">&#127909; Ucaster Channel 2 (Alternate, optional)</div>
                    <div class="form-group">
                        <label for="ucaster_id_2">Channel 2 ID</label>
                        <input type="text" id="ucaster_id_2" name="ucaster_id_2" placeholder="Optional">
                    </div>
                    <div class="form-group">
                        <label for="ucaster_script_2">Channel 2 Script URL</label>
                        <input type="url" id="ucaster_script_2" name="ucaster_script_2" placeholder="Optional">
                    </div>

                    <div class="section-divider-label">&#127942; Team Logos (optional URLs)</div>
                    <div class="form-group">
                        <label for="logo_local">Home Logo URL</label>
                        <input type="url" id="logo_local" name="logo_local" placeholder="https://...">
                    </div>
                    <div class="form-group">
                        <label for="logo_visitante">Away Logo URL</label>
                        <input type="url" id="logo_visitante" name="logo_visitante" placeholder="https://...">
                    </div>
                </div>
