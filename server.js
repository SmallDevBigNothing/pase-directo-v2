...
// Cache Intl.DateTimeFormat instances to avoid expensive instantiation on every SSR loop
...
const localDateFormatter = new Intl.DateTimeFormat('sv-SE', { timeZone: 'Europe/Madrid', year: 'numeric', month: '2-digit', day: '2-digit' });
